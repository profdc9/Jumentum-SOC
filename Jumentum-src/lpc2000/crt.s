...
.global _startup
.global __cs3_interrupt_vector_arm
.global __cs3_reset_arm
.func   _startup
...
.if CPUTYPE==2119 || CPUTYPE==2106 || CPUTYPE==2148
                ldr     PC, [PC,#-0xFF0]
.elseif CPUTYPE==2378
                ldr     PC, [PC,#-0x120]
.else
.print "Error: Need a CPU type to generate crt.o code, e.g. LPC2106 etc."
.fail 0 
.endif
                ldr     PC, FIQ_Addr
...
SWI_Addr:       .word   SoftwareInterrupt	/* defined in main.c  */
